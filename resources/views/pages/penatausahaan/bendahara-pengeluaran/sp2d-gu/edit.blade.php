<form id="sp2d-gu__edit" method="POST" action="{{ route('sp2d-gu.update', $item->id) }}">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col">
    ...
    <div class="row">
        <div class="col">
            <div class="form-group mb-2">
                ...
                <input name="no_cek" class="form-control" value="{{ $item->no_cek }}">
            </div>
        </div>
        <div class="col">
            <div class="form-group mb-2">
...
<script>
    $("#sp2d-gu__edit").on("submit", function (event) {
