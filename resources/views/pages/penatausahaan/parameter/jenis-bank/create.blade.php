<form id="jenis-bank__create" method="POST" action="{{ route('jenis-bank.store') }}">
    @csrf
    ...
    <div class="form-group mb-3">
        ...
        <input required name="kode" class="form-control">
    </div>
...
<script>
    $("#jenis-bank__create").on("submit", function (event) {
