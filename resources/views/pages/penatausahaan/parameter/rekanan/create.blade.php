<form id="rekanan__create" method="POST" action="{{ route('rekanan.store') }}">
    @csrf
    <div class="row">
        <div class="col-md-6">
            <div class="form-group mb-2">
                <label class="form-control-label mb-0">Bentuk Usaha <span class="text-danger">*</span></label>
                <select required name="bentuk_rekanan_id" class="form-control"></select>
            </div>
            <div class="form-group mb-2">
            ...
            <div class="form-group mb-2">
                ...
                <input required name="nama_pimpinan" class="form-control">
            </div>
            <div class="form-group mb-2">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group mb-2">
                ...
                <input required name="nama_rek" class="form-control">
            </div>
            <div class="form-group mb-2">
...
<script>
    $("#rekanan__create").on("submit", function (event) {
