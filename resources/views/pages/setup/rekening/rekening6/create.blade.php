<form id="rekening6__create" method="POST" action="{{ route('rekening6.store') }}">
    @csrf
    ...
    <div class="form-group mb-2">
        ...
        <select required name="rekening3_id" class="form-control"></select>
        <input type="hidden" required name="kode3" class="form-control">
    </div>
    <div class="form-group mb-2">
        <label class="form-control-label mb-0">Rek. Objek <span class="text-danger">*</span></label>
        <select required name="rekening4_id" class="form-control"></select>
        <input type="hidden" required name="kode4" class="form-control">
    </div>
    <div class="form-group mb-2">
        <label class="form-control-label mb-0">Rek. Rincian Objek <span class="text-danger">*</span></label>
        <select required name="rekening5_id" class="form-control"></select>
        <input type="hidden" required name="kode5" class="form-control">
    </div>
    <div class="form-group mb-2">
        ...
        <div class="input-group input-group-merge">
            ...
            <input type="number" required name="kode6" class="form-control">
        </div>
    </div>
...
<script>
    $("#rekening6__create").on("submit", function (event) {
