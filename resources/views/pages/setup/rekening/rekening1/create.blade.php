<form id="rekening1__create" method="POST" action="{{ route('rekening1.store') }}">
    @csrf
    <div class="form-group mb-2">
        <label class="form-control-label mb-0">Kode Rekening <span class="text-danger">*</span></label>
        <input type="number" required name="kode1" class="form-control">
    </div>
...
<script>
    $("#rekening1__create").on("submit", function (event) {
