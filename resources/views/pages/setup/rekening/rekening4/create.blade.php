<form id="rekening4__create" method="POST" action="{{ route('rekening4.store') }}">
    @csrf
    ...
    <div class="form-group mb-2">
        ...
        <div class="input-group input-group-merge">
            ...
            <input type="number" required name="kode4" class="form-control">
        </div>
    </div>
...
<script>
    $("#rekening4__create").on("submit", function (event) {
