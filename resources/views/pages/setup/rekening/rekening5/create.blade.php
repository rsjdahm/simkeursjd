<form id="rekening5__create" method="POST" action="{{ route('rekening5.store') }}">
    @csrf
    ...
    <div class="form-group mb-2">
        ...
        <div class="input-group input-group-merge">
            ...
            <input type="number" required name="kode5" class="form-control">
        </div>
    </div>
...
<script>
    $("#rekening5__create").on("submit", function (event) {
